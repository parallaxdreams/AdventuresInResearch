...
The assets and associated files for this game (the "Software") are released
under a Creative Commons Attribution-NonCommercial-ShareAlike 4.0 International
(CC BY-NC-SA 4.0) License [ Human-readable summary here:
http://creativecommons.org/licenses/by-nc-sa/4.0/ | Full License here:
http://creativecommons.org/licenses/by-nc-sa/4.0/legalcode ] with exceptions
for the following:
* Font files included under SIL Open Font license (see “fonts” folder
for licenses)
...
6.18.3.761; later versions of Ren’Py may require changes to the Software.
